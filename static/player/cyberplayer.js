			...
			return function(w, x) {
				...
				s(la, {
					...
					w.on(b.JWPLAYER_READY, function() {
						...
						w.stop(), a.toggleClass(la, "jw-flag-live", !0), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "none"
					}), x.on("alive", function() {
						...
						a.toggleClass(la, "jw-flag-live", !0), x.get("image") && (c.style.display = "block"), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "none")
					}), x.on("liveStop", function() {
						w.stop(), 
						a.toggleClass(la, "jw-flag-live", !0), a.getElementsByClassName("jw-controlbar", la)[0].style.display = "none"
